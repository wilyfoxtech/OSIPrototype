            ...
            <div class="container-fluid" style="padding-left:0px;">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav navbar-left">
                        <li class="dropdown">
                            <a class="bg-hover-color" href="caseworkerlanding.php" id="MenuColor">Home</a>
                        </li>
                        <li class="dropdown">
            ...
            <div id="divRegisterRegistration">
                <div class="panel panel-default" style="margin-left:15px;margin-right:20px;padding-bottom:10px;"
                    ...
                    <div class="panel-heading">
                        <h3 class="panel-title"><i class="fa fa-exchange">&nbsp;</i>Communication with parent for current case worker</h3>
                    </div>
                    <div style="padding: 20px;overflow: auto;">
                        <form method="post" class="" autocomplete="off" id="frmsavemessage"
                              name="frmsavemessage" role="form" action="savemessage.php">
                            <span class="label label-default">Send message to foster parent</span>
                            <div>
                                <input type="hidden" value="w" name="txttype" id="txttype"/>
                                <div class="form-group">
                                    <div class="col-xs-3" style="padding-left: 0px !important;">
                                        <label class="control-label">Select foster parent</label><span
                        ...
                        <div style="clear: both;padding-top: 20px;">
                            ...
                            <table class="table table-bordered" style="margin-top: 10px;">
                                ...
                                $caseworkerid = $_SESSION['LoginUserID'];

                                //echo $caseworkerid;

                                $query = "select b.fosterparentid, concat(b.FirstName,' ',b.LastName)as 'Name', b.EmailID, a.MessageText, a.MessageDate, ".
                                            ...
                                            "inner join Address c on b.AddressID = c.AddressID inner join caseworker d on a.CaseWorkerID=d.CaseWorkerID where d.CaseWorkerID=" . $caseworkerid . ";";
